...
<tbody>
<?php 
$proQuery= $con->query("SELECT `id`,`NomP`,`Email`,`Telephone`,`Adresse`,`Postale`,`Distance`, `NomEntreprise`,`Registre`,`Description`,`Traite`,`Actif` FROM `professionels` WHERE `Actif`=0 ");
...
<td><?=$pro['Registre']; ?></td>
<td><a href=""><?=$pro['Description']; ?></a></td>
<td>

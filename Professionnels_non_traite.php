...
<tbody>
<?php 
$proQuery= $con->query("SELECT `id`,`NomP`,`Email`,`Telephone`,`Adresse`,`Postale`,`Distance`, `NomEntreprise`,`Registre`,`Description`,`Traite`,`Actif` FROM `professionels` WHERE `Traite`=0 ");
